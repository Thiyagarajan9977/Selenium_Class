...
public class Q7 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		WebElement oracletraining = driver.findElement(By.xpath("//span[contains(text(),'Oracle SQL and PLSQL Placement Certification Training')]"));
		...
		File des = new File("D:\\se\\Selenium\\Day5\\Q7.png");
