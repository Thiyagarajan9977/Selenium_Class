...
public class Q920 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		WebElement air = driver.findElement(By.xpath("//a[contains(text(),'Air Conditioners')]"));
		a.moveToElement(air).perform();

		WebElement ac = driver.findElement(By.xpath("//a[contains(text(),'5 Star ACs')]"));
		ac.click();
		...
		File des = new File("D:\\se\\Selenium\\Day5\\Q20.png");
