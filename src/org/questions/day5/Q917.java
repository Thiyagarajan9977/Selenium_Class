...
public class Q917 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		WebElement women = driver.findElement(By.xpath("//a[contains(text(),'Women Footwear')]"));
		a.moveToElement(women).perform();
		
		
		WebElement slipper = driver.findElement(By.xpath("//a[contains(text(),'Women Slipper Flip Flops')]"));
